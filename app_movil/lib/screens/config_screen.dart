    ...
    return Padding(
      ...
      child: Row(
        children: [
          IconButton(
            onPressed: () {
              // Siempre se llega acá con context.go (reemplaza el stack, no
              // lo apila) desde home/victory/defeat — Navigator.pop no tiene
              // nada de donde volver y deja la pantalla colgada.
              if (context.canPop()) {
                context.pop();
              } else {
                context.go('/home');
